...
export default function Huris( props ) {
  ...
  return (
      <div className = 'page'>
      <GameShell name = "Evolvo" blurb = {evolvoBlurb} src = {evolvoPortrait} devMode = {props.devMode} playersTurn = {props.playersTurn} setPlayersTurn = {props.setPlayersTurn} foe = {foe} setFoe = { setFoe }/>
      </div>
  )
}