...
export default function Test( props ) {
  ...
  return (
      ...
      <GameShell devMode = {props.devMode} testMode = { true } computerOff = { computerOff } setComputerOff = { setComputerOff } playersTurn = {props.playersTurn} setPlayersTurn = {props.setPlayersTurn} foe = { foe } winner = {undefined} squaresClassName = {"mainBoardButton"} values = { trainingSquares } setSquares = {setTrainingSquares} ></GameShell> 
      </div>
  )
}